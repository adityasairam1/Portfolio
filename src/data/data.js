...
export const projects = [
  ...
  },
  {
    ...
    description: "Developed an end-to-end big data processing ecosystem demonstrating expertise across the entire data engineering lifecycle—from data acquisition and ETL to distributed computing and advanced analytics. Processed over 100GB of data across various formats using both relational (SQL Server) and NoSQL (MongoDB) databases, culminating in distributed processing with Hadoop MapReduce and Apache Hive.",
